...
(function sidebar() {
  ...
  const sidebarToggleButtonIcon = document.getElementById(
    "sidebar-toggle-icon"
  );
  ...
  function showSidebar() {
    ...
    sidebarToggleButtonIcon.classList.remove("fa-bars");
    sidebarToggleButtonIcon.classList.remove("fa-arrow-right-to-bracket");
    sidebarToggleButtonIcon.classList.add("fa-arrow-right-to-bracket");
  ...
  function hideSidebar() {
    ...
    sidebarToggleButtonIcon.classList.remove("fa-arrow-right-to-bracket");
    sidebarToggleButtonIcon.classList.remove("fa-bars");
    sidebarToggleButtonIcon.classList.add("fa-bars");
